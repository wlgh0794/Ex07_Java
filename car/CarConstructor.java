...
public class CarConstructor {
	...
	// 항상 접근제어자 + 클래스명(매개변수)으로 지정
	
	// 매개변수가 없는 생성자를 기본생성자라고하며,
	...
	public CarConstructor( String c ) // [ 오버로드 ]
	{
		company = c ;
	}
	
	
	public CarConstructor( String company , String model ) // [ 오버로드 ]
	{
	...
	// 매개변수가 있는 생성자는 받아온 매개변수 값으로 클래스의 속성들을 초기화 한다.
	// 매개변수는 생성자에서 어떤 변수를 초기화하는 명확하게 하기 위해서 
	// 속성 변수명과 일치 시키는게 관례적이다.
